...
namespace WebApplicationTutorial.Controllers
{
    ...
    public class CountryController : Controller
    {
        ...
        public IActionResult CreateCountry([FromBody] CountryDto countryCreate)
        {
            ...
            {
                ModelState.AddModelError("", $"Country with name {country.Name} already exists");
           ...
           if (!_countryRepository.CreateCountry(countryMap))
            ...
            return Ok("Country Added Sucessfully");
        }
        ...
        public IActionResult UpdateCountry(int countryId, CountryDto countryUpdate)
        {
            ...
            {
                ModelState.AddModelError("", $"Something went wrong updating country with id: {countryId}");
                return StatusCode(500, ModelState);
            }
